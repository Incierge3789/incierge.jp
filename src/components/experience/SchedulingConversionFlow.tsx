...
export default function SchedulingConversionFlow() {
    // Diagnosis State
    const [persona, setPersona] = useState<Persona>('tax_accountant');
    ...
    const handleReveal = () => {
        ...
        // Smooth scroll to experience after a tick
        setTimeout(() => {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto font-sans text-gray-800">

            {/* --- SECTION 1: DIAGNOSIS --- */}
            <div className="w-full max-w-2xl mx-auto rounded-3xl bg-white/50 backdrop-blur-sm border border-red-100 shadow-xl overflow-hidden p-6 md:p-10 mb-16 relative z-20">
            ...
            {isExperienceRevealed && (
                <div ref={experienceRef} className="animate-fade-in scroll-mt-24">
                    {/* Experience Header */}
                    <div className="mb-8 text-center transition-all duration-500">
                        <h3 className="text-xl md:text-3xl font-bold bg-gradient-to-r from-blue-700 to-indigo-600 bg-clip-text text-transparent">
                            日程調整を「消去」する体験
                        </h3>
                        <p className="text-xs text-gray-500 mt-2">
                    ...
                    <div className="animate-fade-in-up delay-500">
                        <div className="bg-gray-900 text-white p-8 rounded-xl shadow-2xl relative overflow-hidden text-center not-prose">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl"></div>
                            <h3 className="text-xl font-bold mb-3 relative z-10">「日程調整作業」を今すぐ止めませんか？</h3>
                            <p className="text-sm text-gray-300 mb-6 relative z-10">
                                この体験は一例です。INCIERGEは、士業事務所の「意思決定を伴わない作業」を徹底的に排除します。
                            </p>
                            <a href="/contact" className="inline-block bg-white text-gray-900 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-colors relative z-10">
                                日程調整作業を止める（無料相談）
                            </a>
                        </div>
                    </div>
